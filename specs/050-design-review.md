...
- [x] Generalized Diagram renderer + scripted frame player
- [x] 12 flaw puzzles (4 exist; author 8 via docs/content-pipeline.md §3 recipe;
      ladder per product-spec §3.5 incl. one "actually fine" puzzle)
- [x] 6 predict rounds (2 exist) incl. one with confidence-interval scoring
- [x] 6 taste tests (2 exist) using the distractor taxonomy; "Tables Turn" mandatory
- [x] Daily Incident: date-seeded daily puzzle, streak, spoiler-free share string;
      app landing card
- [x] Par times displayed; teach-back prompt after solves (60s, 3-item self-rubric,
      logged to Scar Journal)
- [x] Aggregate judgment score + weakest-category surfacing
