...
- [x] Framework: vague stakeholder pitch; ~10 clarifying questions (mixed value),
...
- [x] Post-mortem: full question list ranked by information value, with "what each
      answer would have changed"
- [x] 6 interrogations; template { stakeholderPitch, questions[{text, cost, reveals,
