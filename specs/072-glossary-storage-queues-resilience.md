...
- [x] Every key in coverage-map §B.3 for **Storage & Data** (20), **Queues &
...
- [x] The four flagged entries get review-gate care per §B.3's contract notes:
...
- [x] Existing entries in these three groups are BACKFILLED with the speakable
...
- [x] Each new key lands in exactly one reference group (the partition test
...
- [x] verify.sh green; Reference screen reviewed at 380px (it grows a lot)
