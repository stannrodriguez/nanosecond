...
- [x] Every key in coverage-map §B.3 for **Networking** (`graphql`, `nat`,
...
- [x] The Caching & Delivery group's existing entries (`cache`, `hitrate`,
      ...
      comply on arrival)
- [x] Requests & Traffic: the 5 new keys carry the contract; group-wide
...
- [x] Orphan-entry rule as in 072: wire terms into copy or justify each
      allowlist addition
- [x] verify.sh green; Reference screen reviewed at 380px
