...
export const TOYS: ToyEntry[] = [
  {
    ...
    oneLiner: 'Pick an operation. Watch how far light gets in the time it takes.',
    ch: 'net',
  ...
  },
  {
    ...
    oneLiner: 'RAM is billions of leaking capacitors, refreshed forever. Turn the refresh off.',
    ch: 'mem',
